...
- Kafka sink to open fewer threads
- Explicitly return 408 when timeout is hit
- Extend default timeouts to match upstream defaults

### Fixed
- Remove parts of the cookies that are not valid according to RFC 6265
...
### Security
- Bump aws sdk to 1.12.769
- Bump azure-identity to 1.13.2
